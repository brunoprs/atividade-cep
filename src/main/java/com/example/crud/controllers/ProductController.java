...
import com.example.crud.service.CepService;
...
public class ProductController {
    ...
    // Novo endpoint da Tarefa 4
    @Autowired
    private ProductService productService;

    @GetMapping("/check-distribution/{cep}/{id}")
    public ResponseEntity<Boolean> checkDistribution(@PathVariable String cep, @PathVariable String id) {
        boolean result = productService.verificaCidadeCep(cep, id);
